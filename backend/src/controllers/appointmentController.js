...
export const updateAppointment = async (req, res) => {
  try {
    ...
    await Notification.create({
      ...
      message: `Your appointment for ${appointment.serviceType || 'a Service'} has been updated to ${appointment.status}. Time: ${new Date(appointment.dateTime).toLocaleString([], { dateStyle: 'medium', timeStyle: 'short' })}`,
