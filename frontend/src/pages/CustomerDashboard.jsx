...
import { Ticket, LogOut, ExternalLink, X, MessageSquare } from 'lucide-react';
...
const CustomerDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-transparent font-sans text-slate-800">
      <nav className="bg-white/60 backdrop-blur-md border-b border-white/50 px-4 md:px-8 py-4 flex flex-col md:flex-row justify-between items-center gap-4 shadow-sm">
