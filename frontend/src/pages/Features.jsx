          ...
          <div className="space-y-24">
            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
              <div className="md:w-1/2">
                ...
                <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">Intelligent AI Chatbot</h2>
                ...
                <ul className="space-y-3">
                  <li className="flex items-center text-slate-700 dark:text-slate-200"><CheckCircle className="text-blue-500 mr-3" size={20} /> Natural Language Processing</li>
                  <li className="flex items-center text-slate-700 dark:text-slate-200"><CheckCircle className="text-blue-500 mr-3" size={20} /> Zero-setup widget integration</li>
                  <li className="flex items-center text-slate-700 dark:text-slate-200"><CheckCircle className="text-blue-500 mr-3" size={20} /> Smart intent detection</li>
                </ul>
              </div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center gap-12">
              <div className="md:w-1/2">
                ...
                <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">Self-updating AI FAQ</h2>
                <p className="text-lg text-slate-600 dark:text-slate-300 mb-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-center text-slate-700 dark:text-slate-200"><CheckCircle className="text-emerald-500 mr-3" size={20} /> Auto-suggested FAQs from tickets</li>
                  <li className="flex items-center text-slate-700 dark:text-slate-200"><CheckCircle className="text-emerald-500 mr-3" size={20} /> Searchable public Help Center</li>
                  <li className="flex items-center text-slate-700 dark:text-slate-200"><CheckCircle className="text-emerald-500 mr-3" size={20} /> Direct chatbot integration</li>
                </ul>
              </div>
              <div className="md:w-1/2 bg-slate-900/60 backdrop-blur-xl rounded-3xl p-8 border border-slate-900 dark:border-white/50 shadow-xl hover:-translate-y-1 transition-transform duration-300">
            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
              <div className="md:w-1/2">
                ...
                <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">Conversational Lead Capture</h2>
                <p className="text-lg text-slate-600 dark:text-slate-300 mb-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-center text-slate-700 dark:text-slate-200"><CheckCircle className="text-amber-500 mr-3" size={20} /> No boring static forms</li>
                  <li className="flex items-center text-slate-700 dark:text-slate-200"><CheckCircle className="text-amber-500 mr-3" size={20} /> Collects Name, Email, Phone seamlessly</li>
                  <li className="flex items-center text-slate-700 dark:text-slate-200"><CheckCircle className="text-amber-500 mr-3" size={20} /> Syncs directly to your Admin Leads Dashboard</li>
                </ul>
              </div>
              <div className="md:w-1/2 bg-slate-900/60 backdrop-blur-xl rounded-3xl p-8 border border-slate-900 dark:border-white/50 shadow-xl hover:-translate-y-1 transition-transform duration-300">
                 <div className="flex flex-col space-y-4">
            ...
            <div className="flex flex-col md:flex-row-reverse items-center gap-12">
              <div className="md:w-1/2">
                ...
                <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">Automated Appointment Booking</h2>
                <p className="text-lg text-slate-600 dark:text-slate-300 mb-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-center text-slate-700 dark:text-slate-200"><CheckCircle className="text-rose-500 mr-3" size={20} /> 24-hour and 1-hour automated reminders</li>
                  <li className="flex items-center text-slate-700 dark:text-slate-200"><CheckCircle className="text-rose-500 mr-3" size={20} /> Auto-generated Google Meet mock links</li>
                  <li className="flex items-center text-slate-700 dark:text-slate-200"><CheckCircle className="text-rose-500 mr-3" size={20} /> Dedicated Master Schedule for Admins</li>
                </ul>
              </div>
              <div className="md:w-1/2 bg-slate-900/60 backdrop-blur-xl rounded-3xl p-8 border border-slate-900 dark:border-white/50 shadow-xl hover:-translate-y-1 transition-transform duration-300">
                 <div className="bg-rose-50 p-4 rounded-xl flex items-center justify-between border border-rose-100">
                   ...
                   <div className="bg-white dark:bg-slate-900 text-rose-600 px-3 py-1 rounded text-xs font-bold shadow-sm border border-rose-200">
                     Confirmed
                   </div>
                 </div>
              </div>
